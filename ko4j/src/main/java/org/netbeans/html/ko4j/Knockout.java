...
final class Knockout extends WeakReference<Object> {
    ...
    @JavaScriptBody(
        ...
        + "    try {\n"
        + "      var s = ret['ko4j'];\n"
        + "      var v = s.@org.netbeans.html.ko4j.Knockout::getValue(I)(index);\n"
        + "      return v;\n"
        + "    } catch (e) {\n"
        + "      alert(\"Cannot call getValue on \" + ret['ko4j'] + \" prop: \" + name + \" error: \" + e);\n"
        + "    }\n"
        + "  }\n"
        ...
        + "    var s = ret['ko4j'];\n"
        + "    s.@org.netbeans.html.ko4j.Knockout::call(ILjava/lang/Object;Ljava/lang/Object;)(index, data, ev);\n"
        + "  };\n"
        + "}\n"
