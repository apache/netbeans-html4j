...
public final class Proto {
    ...
    private Watcher mine;
    private Watcher.Ref observers;
    private static Watcher locked;
    ...
    public void acquireLock() throws IllegalStateException {
        if (locked != null) throw new IllegalStateException();
        locked = Watcher.DUMMY;
    }
    public void acquireLock(String propName) throws IllegalStateException {
        if (locked != null) throw new IllegalStateException();
        locked = Watcher.computing(this, propName);
    }
    
    public void accessValue(String propName) {
        if (locked != null) {
            if (locked.forbiddenValue(this)) {
                throw new IllegalStateException();
            }
            observers = locked.observe(observers, propName);
        }
    }
    ...
    public void releaseLock() {
        mine = Watcher.register(mine, locked);
        locked = null;
    }
    ...
    public void valueHasMutated(final String propName) {
        context.execute(new Runnable() {
            ...
            public void run() {
                ...
                if (observers != null) {
                    observers = Watcher.Ref.valueHasMutated(observers, propName);
                }
            }
        });
    }
    ...
    final Watcher watcher(String prop) {
        return Watcher.find(mine, prop);
    }
