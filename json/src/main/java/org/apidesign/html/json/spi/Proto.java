...
import org.apidesign.html.json.spi.Watcher.Observers;
import org.apidesign.html.json.spi.Watcher.Watchers;
...
public final class Proto {
    ...
    public void acquireLock(String propName) throws IllegalStateException {
        Watcher.beginComputing(this, propName);
    }
    
    public void accessValue(String propName) {
        observers = Watcher.accessingValue(this, observers, propName);
    }
    ...
    public void releaseLock() {
        mine = Watcher.finishComputing(this, mine);
    }
    ...
    final Watcher watcher(String prop) {
        return mine == null ? null : mine.find(prop);
    }
